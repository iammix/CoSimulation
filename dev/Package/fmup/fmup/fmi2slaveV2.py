...
class Fmi2Slave(ABS):
    ...
    def to_xml(self, model_options: Dict[str, str] = dict()) -> Element:
        ...
        attrib = dict(
            ...
            generationTool="fmup {}".format(VERSION),
    ...
    def get_integer(self, vrs: List[int]) -> List[int]:
        ...
        for vr in vrs:
            ...
            if isinstance(var, Integer):
                ...
                raise TypeError("Variable with valueReference={} is not of type Integer".format(vr))
        return refs
    ...
    def get_real(self, vrs: List[int]) -> List[float]:
        ...
        for vr in vrs:
            ...
            if isinstance(var, Real):
                ...
                raise TypeError("Variable with valueReference={} is not of type Real!".format(vr))
        return refs
    ...
    def get_boolean(self, vrs: List[int]) -> List[bool]:
        ...
        for vr in vrs:
            ...
            if isinstance(var, Boolean):
                ...
                raise TypeError("Variable with valueReference={} is not of type Boolean".format(vr))
        return refs
    ...
    def get_string(self, vrs: List[int]) -> List[str]:
        ...
        for vr in vrs:
            ...
            if isinstance(var, String):
                ...
                raise TypeError("Variable with valueReference={} is not of type String".format(vr))
        return refs
        ...
        if self.logger is not None and self.resources is not None:
            if self.__lib is None and not self.__lib_error:
                ...
                try:
                    ...
                    print("Warning!! Unable to setup logging for FMU instance: {}".format(self.instance_name))

            if not self.__lib_error:
                if category is None:
                    category = "logStatus{}".format(status.name.capitalize())

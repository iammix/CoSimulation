...
cdef
void
importlogger_default(FMIL.jm_callbacks * c, FMIL.jm_string
module, FMIL.jm_log_level_enu_t
log_level, FMIL.jm_string
message):
msg = decode(message)
mod = decode(module)
...
cdef
void
importlogger(FMIL.jm_callbacks * c, FMIL.jm_string
module, FMIL.jm_log_level_enu_t
log_level, FMIL.jm_string
message):
if c.context != NULL:
...
cdef
void
importlogger2(FMIL.jm_callbacks * c, FMIL.jm_string
module, FMIL.jm_log_level_enu_t
log_level, FMIL.jm_string
message):
if c.context != NULL:
...
cdef
void
importlogger_load_fmu(FMIL.jm_callbacks * c, FMIL.jm_string
module, FMIL.jm_log_level_enu_t
log_level, FMIL.jm_string
message):
...
class ModelBase:
    ...
    def get_log_file_name(self):
        logging.warning(
            "The method 'get_log_file_name()' is deprecated and will be removed. Please use 'get_log_filename()' instead.")
    ...
    def get_log(self, int start_lines = -1, int
...
class FMUModelBase(ModelBase):
    ...
    def __init__(self, fmu, path='.', enable_logging=None, log_file_name="", log_level=FMI_DEFAULT_LOG_LEVEL,
                 _unzipped_dir=None, _connect_dll=True):
        """
        Constructor.
        """
        cdef
        ...
        if enable_logging == None:
            if log_level >= FMIL.jm_log_level_nothing and log_level <= FMIL.jm_log_level_all:
                ...
                raise FMUException(
                    "The log level must be between %d and %d" % (FMIL.jm_log_level_nothing, FMIL.jm_log_level_all))
        else:
            logging.warning(
                "The attribute 'enable_logging' is deprecated. Please use 'log_level' instead. Setting 'log_level' to INFO...")
        ...
        if version == FMIL.fmi_version_unknown_enu:
            ...
            if self.callbacks.log_level >= FMIL.jm_log_level_error:
                ...
                raise FMUException(
                    "The FMU version could not be determined. Enable logging for possibly more information.")
        if version != 1:
...
def get_real(self, valueref):
    ...
    nref
    cdef
    N.ndarray[FMIL.fmi1_value_reference_t, ndim = 1, mode = 'c'] val_ref = N.array(valueref, copy=False,
                                                                                   dtype=N.uint32).ravel()
    nref = len(val_ref)
    cdef
    N.ndarray[FMIL.fmi1_real_t, ndim = 1, mode = 'c'] val = N.array([0.0] * nref, dtype=N.float, ndmin=1)

    status = FMIL.fmi1_import_get_real(
        self._fmu, < FMIL.fmi1_value_reference_t * > val_ref.data, nref, < FMIL.fmi1_real_t * > val.data)
...
def set_real(self, valueref, values):
    ...
    N.ndarray[FMIL.fmi1_value_reference_t, ndim = 1, mode = 'c'] val_ref = N.array(valueref, copy=False,
                                                                                   dtype=N.uint32).ravel()
    cdef
    N.ndarray[FMIL.fmi1_real_t, ndim = 1, mode = 'c'] val = N.array(values, copy=False, dtype=N.float).ravel()
    nref = val_ref.size
    ...
    status = FMIL.fmi1_import_set_real(
        self._fmu, < FMIL.fmi1_value_reference_t * > val_ref.data, nref, < FMIL.fmi1_real_t * > val.data)
...
def get_integer(self, valueref):
    ...
    nref
    cdef
    N.ndarray[FMIL.fmi1_value_reference_t, ndim = 1, mode = 'c'] val_ref = N.array(valueref, dtype=N.uint32,
                                                                                   ndmin=1).ravel()

    nref = val_ref.size
    cdef
    N.ndarray[FMIL.fmi1_integer_t, ndim = 1, mode = 'c'] val = N.array([0] * nref, dtype=int, ndmin=1)

    status = FMIL.fmi1_import_get_integer(
        self._fmu, < FMIL.fmi1_value_reference_t * > val_ref.data, nref, < FMIL.fmi1_integer_t * > val.data)
...
def set_integer(self, valueref, values):
    ...
    N.ndarray[FMIL.fmi1_value_reference_t, ndim = 1, mode = 'c'] val_ref = N.array(valueref, dtype=N.uint32,
                                                                                   ndmin=1).ravel()
    cdef
    N.ndarray[FMIL.fmi1_integer_t, ndim = 1, mode = 'c'] val = N.array(values, dtype=int, ndmin=1).ravel()
    ...
    status = FMIL.fmi1_import_set_integer(
        self._fmu, < FMIL.fmi1_value_reference_t * > val_ref.data, nref, < FMIL.fmi1_integer_t * > val.data)
...
def get_boolean(self, valueref):
    ...
    nref = val_ref.size
    cdef
    void * val = FMIL.malloc(sizeof(FMIL.fmi1_boolean_t) * nref)

    status = FMIL.fmi1_import_get_boolean(
        self._fmu, < FMIL.fmi1_value_reference_t * > val_ref.data, nref, < FMIL.fmi1_boolean_t * > val)
...
def set_boolean(self, valueref, values):
    ...
    status = FMIL.fmi1_import_set_boolean(
        self._fmu, < FMIL.fmi1_value_reference_t * > val_ref.data, nref, < FMIL.fmi1_boolean_t * > val)
...
def get_string(self, valueref):
    ...
    status
    cdef
    N.ndarray[FMIL.fmi1_value_reference_t, ndim = 1, mode = 'c'] input_valueref = N.array(valueref, dtype=N.uint32,
                                                                                          ndmin=1).ravel()
    cdef
    FMIL.fmi1_string_t * output_value = < FMIL.fmi1_string_t * > FMIL.malloc(
        sizeof(FMIL.fmi1_string_t) * input_valueref.size)

    status = FMIL.fmi1_import_get_string(
        self._fmu, < FMIL.fmi1_value_reference_t * > input_valueref.data, input_valueref.size, output_value)
...
def set_string(self, valueref, values):
    ...
    N.ndarray[FMIL.fmi1_value_reference_t, ndim = 1, mode = 'c'] val_ref = N.array(valueref, dtype=N.uint32,
                                                                                   ndmin=1).ravel()
    cdef
    FMIL.fmi1_string_t * val = < FMIL.fmi1_string_t * > FMIL.malloc(sizeof(FMIL.fmi1_string_t) * val_ref.size)
...
def set_fmil_log_level(self, FMIL.
...
def _set(self, variable_name, value):
    """
        ...
        """
    cdef
    FMIL.fmi1_value_reference_t
    ref
    cdef
    FMIL.fmi1_base_type_enu_t
    type
    cdef
    FMIL.fmi1_import_variable_t * variable
    cdef
    FMIL.fmi1_variable_alias_kind_enu_t
    alias_kind

    variable_name = encode(variable_name)
    cdef
    char * variablename = variable_name
...
cpdef
get_variable_description(self, variable_name):
"""
...
cdef
_add_scalar_variable(self, FMIL.fmi1_import_variable_t * variable):
...
cpdef
FMIL.fmi1_base_type_enu_t
get_variable_data_type(self, variable_name) except *:
"""
...
cpdef
FMIL.fmi1_value_reference_t
get_variable_valueref(self, variable_name) except *:
"""
...
def get_variable_nominal(self, variable_name=None, valueref=None, _override_erroneous_nominal=True):
    ...
    FMIL.fmi1_import_variable_t * variable
    cdef
    FMIL.fmi1_import_real_variable_t * real_variable
    cdef
    ...
    if valueref != None:
        variable = FMIL.fmi1_import_get_variable_by_vr(self._fmu,
                                                       FMIL.fmi1_base_type_real, < FMIL.fmi1_value_reference_t > valueref)
        if variable == NULL:
    ...
    if _override_erroneous_nominal:
        ...
        if value == 0.0:
            if self.callbacks.log_level >= FMIL.jm_log_level_warning:
                logging.warning(
                    "The nominal value for %s is 0.0 which is illegal according to the FMI specification. Setting the nominal to 1.0" % variablename)
            value = 1.0
        elif value < 0.0:
            if self.callbacks.log_level >= FMIL.jm_log_level_warning:
                logging.warning(
                    "The nominal value for %s is <0.0 which is illegal according to the FMI specification. Setting the nominal to abs(%g)" % (
                    variablename, value))
            value = abs(value)
...
cpdef
get_variable_fixed(self, variable_name):
"""
...
cpdef
get_variable_start(self, variable_name):
"""
...
FMIL.fmi1_import_variable_t * variable
cdef
FMIL.fmi1_import_integer_variable_t * int_variable
cdef
FMIL.fmi1_import_real_variable_t * real_variable
cdef
FMIL.fmi1_import_bool_variable_t * bool_variable
cdef
FMIL.fmi1_import_enum_variable_t * enum_variable
cdef
FMIL.fmi1_import_string_variable_t * str_variable
cdef
FMIL.fmi1_base_type_enu_t
type
cdef
...
cpdef
get_variable_max(self, variable_name):
"""
...
cpdef
get_variable_min(self, variable_name):
"""
...
FMIL.fmi1_import_variable_t * variable
cdef
FMIL.fmi1_import_variable_list_t * variable_list
cdef
FMIL.size_t
variable_list_size
cdef
...
cdef
FMIL.fmi1_base_type_enu_t
data_type, target_type = FMIL.fmi1_base_type_real
cdef
FMIL.fmi1_variability_enu_t
data_variability, target_variability = FMIL.fmi1_variability_enu_constant
cdef
FMIL.fmi1_causality_enu_t
data_causality, target_causality = FMIL.fmi1_causality_enu_input
cdef
FMIL.fmi1_variable_alias_kind_enu_t
alias_kind
cdef
...
cdef
list
filter_list = [], variable_return_list = []
cdef
int
selected_type = 0  # If a type has been selected
cdef
int
selected_variability = 0  # If a variability has been selected
cdef
int
selected_causality = 0  # If a causality has been selected
cdef
int
has_start, is_fixed
cdef
int
selected_filter = 1 if filter else 0
cdef
int
length_filter = 0
    ...
    if include_alias:
        if _as_list:
            variable_return_list.append(ScalarVariable(name,
                                                       value_ref, data_type,
                                                       desc.decode('UTF-8') if desc != NULL else "",
...
def get_model_time_varying_value_references(self, filter=None):
    ...
    FMIL.fmi1_import_variable_t * variable
    cdef
    FMIL.fmi1_import_variable_t * base_variable
    cdef
    FMIL.fmi1_import_variable_list_t * variable_list
    cdef
    FMIL.size_t
...
def get_variable_alias(self, variable_name):
    ...
    FMIL.fmi1_import_variable_t * variable
    cdef
    FMIL.fmi1_import_variable_list_t * alias_list
    cdef
    FMIL.size_t
    alias_list_size
    cdef
...
cpdef
FMIL.fmi1_variability_enu_t
get_variable_variability(self, variable_name) except *:
"""
...
def get_variable_by_valueref(self, FMIL.


    fmi1_value_reference_t
valueref, type = 0):
"""
...
cpdef
FMIL.fmi1_causality_enu_t
get_variable_causality(self, variable_name) except *:
"""
...
class FMUModelCS1(FMUModelBase):
...
cpdef
_set_time(self, FMIL.fmi1_real_t
t):
self.__t = t
...
def do_step(self, FMIL.


    fmi1_real_t
current_t, FMIL.fmi1_real_t
step_size, new_step = True):
"""
...
def get_output_derivatives(self, variables, FMIL.
...
unsigned
int
max_output_derivative
cdef
FMIL.size_t
nref
cdef
N.ndarray[FMIL.fmi1_real_t, ndim = 1, mode = 'c'] values
cdef
N.ndarray[FMIL.fmi1_value_reference_t, ndim = 1, mode = 'c'] value_refs
cdef
N.ndarray[FMIL.fmi1_integer_t, ndim = 1, mode = 'c'] orders
cdef
FMIL.fmi1_import_capabilities_t * fmu_capabilities
...
if order < 1 or order > max_output_derivative:
    raise FMUException(
        "The order must be greater than zero and below the maximum output derivative support of the FMU (%d)." % max_output_derivative)
...
status = FMIL.fmi1_import_get_real_output_derivatives(
    self._fmu, < FMIL.fmi1_value_reference_t * > value_refs.data, nref, < FMIL.fmi1_integer_t * > orders.data, < FMIL.fmi1_real_t * > values.data)
...
def get_real_status(self, status_kind):
    ...
    if status_kind == FMIL.fmi1_last_successful_time:
        ...
        if status != 0:
            raise FMUException(
                'Failed to retrieve the last successful time. See the log for possibly more information.')
...
def set_input_derivatives(self, variables, values, orders):
    ...
    FMIL.fmi1_import_capabilities_t * fmu_capabilities
    cdef
    N.ndarray[FMIL.fmi1_integer_t, ndim = 1, mode = 'c'] np_orders = N.array(orders, dtype=N.int32, ndmin=1).ravel()
    cdef
    N.ndarray[FMIL.fmi1_value_reference_t, ndim = 1, mode = 'c'] value_refs
    cdef
    N.ndarray[FMIL.fmi1_real_t, ndim = 1, mode = 'c'] val = N.array(values, dtype=N.float, ndmin=1).ravel()
    ...
    status = FMIL.fmi1_import_set_real_input_derivatives(
        self._fmu, < FMIL.fmi1_value_reference_t * > value_refs.data, nref, < FMIL.fmi1_integer_t * > np_orders.data, < FMIL.fmi1_real_t * > val.data)
...
def initialize(self, start_time=0.0, stop_time=1.0, stop_time_defined=False, tStart=None, tStop=None,
               StopTimeDefined=None):
    """
    ...
    if StopTimeDefined is not None:
        logging.warning(
            "The attribute 'StopTimeDefined' is deprecated and will be removed. Please use 'stop_time_defined' instead.")
...
def get_capability_flags(self):
    ...
    capabilities = {}
    cdef
    FMIL.fmi1_import_capabilities_t * cap

    cap = FMIL.fmi1_import_get_capabilities(self._fmu)

    capabilities[
        "canHandleVariableCommunicationStepSize"] = FMIL.fmi1_import_get_canHandleVariableCommunicationStepSize(cap)
...
class FMUModelME1(FMUModelBase):
    """
    An FMI Model loaded from a DLL.
    """
...
def _get_continuous_states(self):
    ...
    status
    cdef
    N.ndarray[double, ndim = 1, mode = 'c'] ndx = N.zeros(self._nContinuousStates, dtype=N.double)
...
def _set_continuous_states(self, N.


    ndarray[FMIL.fmi1_real_t]
values):
cdef
int
status
cdef
N.ndarray[FMIL.fmi1_real_t, ndim = 1, mode = 'c'] ndx = values
...
def _get_nominal_continuous_states(self):
    ...
    status
    cdef
    N.ndarray[FMIL.fmi1_real_t, ndim = 1, mode = 'c'] ndx = N.zeros(self._nContinuousStates, dtype=N.double)
...
status
cdef
N.ndarray[FMIL.fmi1_real_t, ndim = 1, mode = 'c'] values = N.empty(self._nContinuousStates, dtype=N.double)
...
def get_event_indicators(self):
    ...
    status
    cdef
    N.ndarray[FMIL.fmi1_real_t, ndim = 1, mode = 'c'] values = N.empty(self._nEventIndicators, dtype=N.double)

    status = FMIL.fmi1_import_get_event_indicators(
        self._fmu, < FMIL.fmi1_real_t * > values.data, self._nEventIndicators)
...
def event_update(self, intermediateResult=False):
    ...
    def get_state_value_references(self):
        ...
        status
        cdef
        N.ndarray[FMIL.fmi1_value_reference_t, ndim = 1, mode = 'c'] values = N.zeros(self._nContinuousStates,
                                                                                      dtype=N.uint32)
    ...
    def initialize(self, tolerance_defined=True, tolerance="Default", tolControlled=None, relativeTolerance=None):
        ...
        if tolControlled is not None:
            logging.warning(
                "The attribute 'tolControlled' is deprecated and will be removed. Please use 'tolerance_defined' instead.")
            tolerance_defined = tolControlled  # If the user has used this, use it!
        if relativeTolerance is not None:
            logging.warning(
                "The attribute 'relativeTolerance' is deprecated and will be removed. Please use 'tolerance' instead.")
...
class FMUModelBase2(ModelBase):
    ...
    def __init__(self, fmu, path='.', enable_logging=None, log_file_name="", log_level=FMI_DEFAULT_LOG_LEVEL,
        ...
        if self._version != FMIL.fmi_version_2_0_enu:
            ...
            if enable_logging:
                ...
                raise FMUException(
                    "The FMU version is not supported by this class. Enable logging for possibly more information.")
        ...
        if self._fmu_kind == FMIL.fmi2_fmu_kind_unknown:
            ...
            if enable_logging:
                ...
                raise FMUException(
                    "The FMU kind could not be determined. Enable logging for possibly more information.")
    ...
    cdef
    N.ndarray[FMIL.fmi2_value_reference_t, ndim = 1, mode = 'c'] input_valueref = N.array(valueref, copy=False,
                                                                                          dtype=N.uint32).ravel()
    cdef
    N.ndarray[FMIL.fmi2_real_t, ndim = 1, mode = 'c']            output_value = N.zeros(input_valueref.size)

    status = FMIL.fmi2_import_get_real(
        self._fmu, < FMIL.fmi2_value_reference_t * > input_valueref.data, input_valueref.size, < FMIL.fmi2_real_t * > output_value.data)
...
N.ndarray[FMIL.fmi2_value_reference_t, ndim = 1, mode = 'c'] input_valueref = N.array(valueref, copy=False,
                                                                                      dtype=N.uint32).ravel()
cdef
N.ndarray[FMIL.fmi2_real_t, ndim = 1, mode = 'c']            set_value = N.array(values, copy=False,
                                                                                 dtype=N.float).ravel()

if input_valueref.size != set_value.size:
    raise FMUException('The length of valueref and values are inconsistent.')

status = FMIL.fmi2_import_set_real(
    self._fmu, < FMIL.fmi2_value_reference_t * > input_valueref.data, input_valueref.size, < FMIL.fmi2_real_t * > set_value.data)
...
cdef
int
_get_real(self, FMIL.fmi2_value_reference_t[:]
valueref, size_t
size, FMIL.fmi2_real_t[:]
values):
return FMIL.fmi2_import_get_real(self._fmu, & valueref[0], size, & values[0])

cdef
int
__get_real(self, FMIL.fmi2_value_reference_t * vrefs, size_t
size, FMIL.fmi2_real_t * values):
return FMIL.fmi2_import_get_real(self._fmu, vrefs, size, values)

cdef
int
__set_real(self, FMIL.fmi2_value_reference_t * vrefs, FMIL.fmi2_real_t * values, size_t
size):
return FMIL.fmi2_import_set_real(self._fmu, vrefs, size, values)

cdef
int
_get_integer(self, FMIL.fmi2_value_reference_t[:]
valueref, size_t
size, FMIL.fmi2_integer_t[:]
values):
...
def get_integer(self, valueref):
    ...
    cdef
    N.ndarray[FMIL.fmi2_value_reference_t, ndim = 1, mode = 'c'] input_valueref = N.array(valueref, dtype=N.uint32,
                                                                                          ndmin=1).ravel()
    nref = input_valueref.size
    cdef
    N.ndarray[FMIL.fmi2_integer_t, ndim = 1, mode = 'c']         output_value = N.zeros(nref, dtype=int)

    status = FMIL.fmi2_import_get_integer(
        self._fmu, < FMIL.fmi2_value_reference_t * > input_valueref.data, nref, < FMIL.fmi2_integer_t * > output_value.data)
...
def set_integer(self, valueref, values):
    ...
    N.ndarray[FMIL.fmi2_value_reference_t, ndim = 1, mode = 'c'] input_valueref = N.array(valueref, dtype=N.uint32,
                                                                                          ndmin=1).ravel()
    cdef
    N.ndarray[FMIL.fmi2_integer_t, ndim = 1, mode = 'c']         set_value = N.array(values, dtype=int, ndmin=1).ravel()
    ...
    status = FMIL.fmi2_import_set_integer(
        self._fmu, < FMIL.fmi2_value_reference_t * > input_valueref.data, nref, < FMIL.fmi2_integer_t * > set_value.data)
...
cdef
int
_get_boolean(self, FMIL.fmi2_value_reference_t[:]
valueref, size_t
size, FMIL.fmi2_real_t[:]
values):
cdef
...
status
cdef
void * output_value = FMIL.malloc(sizeof(FMIL.fmi2_boolean_t) * size)
...
def get_boolean(self, valueref):
    ...
    cdef
    void * output_value = FMIL.malloc(sizeof(FMIL.fmi2_boolean_t) * nref)

    status = FMIL.fmi2_import_get_boolean(
        self._fmu, < FMIL.fmi2_value_reference_t * > input_valueref.data, nref, < FMIL.fmi2_boolean_t * > output_value)
...
def set_boolean(self, valueref, values):
    ...
    cdef
    void * set_value = FMIL.malloc(sizeof(FMIL.fmi2_boolean_t) * nref)
    ...
    status = FMIL.fmi2_import_set_boolean(
        self._fmu, < FMIL.fmi2_value_reference_t * > input_valueref.data, nref, < FMIL.fmi2_boolean_t * > set_value)
...
def get_string(self, valueref):
    ...
    N.ndarray[FMIL.fmi2_value_reference_t, ndim = 1, mode = 'c'] input_valueref = N.array(valueref, dtype=N.uint32,
                                                                                          ndmin=1).ravel()
    cdef
    FMIL.fmi2_string_t * output_value = < FMIL.fmi2_string_t * > FMIL.malloc(
        sizeof(FMIL.fmi2_string_t) * input_valueref.size)

    status = FMIL.fmi2_import_get_string(
        self._fmu, < FMIL.fmi2_value_reference_t * > input_valueref.data, input_valueref.size, output_value)
...
def set_string(self, valueref, values):
    ...
    status
    cdef
    N.ndarray[FMIL.fmi2_value_reference_t, ndim = 1, mode = 'c'] val_ref = N.array(valueref, dtype=N.uint32,
                                                                                   ndmin=1).ravel()
    cdef
    FMIL.fmi2_string_t * val = < FMIL.fmi2_string_t * > FMIL.malloc(sizeof(FMIL.fmi2_string_t) * val_ref.size)
...
def _set(self, variable_name, value):
    """
        ...
        """
    cdef
    FMIL.fmi2_value_reference_t
    ref
    cdef
    FMIL.fmi2_base_type_enu_t
    type
        ...
        if isinstance(value, str) or isinstance(value, bytes):
            ...
            try:
                ...
                msg = "The value '{}' is not in the list of allowed enumeration items for variable '{}'. Allowed values: {}'.".format(
                    decode(value), decode(variable_name), ", ".join(str_keys))
...
def instantiate(self, name='Model', visible=False):
    ...
    if isinstance(self, FMUModelME2):
        ...
        raise FMUException(
            'The instance is not curent an instance of an ME-model or a CS-model. Use load_fmu for correct loading.')
...
def setup_experiment(self, tolerance_defined=True, tolerance="Default", start_time="Default", stop_time_defined=False,
                     stop_time="Default"):
    """
    ...
    cdef
    FMIL.fmi2_boolean_t
    stop_defined = FMI2_TRUE if stop_time_defined else FMI2_FALSE
    cdef
    FMIL.fmi2_boolean_t
    tol_defined = FMI2_TRUE if tolerance_defined else FMI2_FALSE
...
def initialize(self, tolerance_defined=True, tolerance="Default", start_time="Default", stop_time_defined=False,
               stop_time="Default"):
    """
        Initializes the model and computes initial values for all variables.
...
def set_debug_logging(self, logging_on, categories=[]):
    ...
    if len(categories) > 0:
        raise FMUException(
            'Currently the logging of categories is not available. See the docstring for more information')
...
def get_categories(self):
    ...
    cdef
    FMIL.size_t
    i, nbr_categories = FMIL.fmi2_import_get_log_categories_num(self._fmu)
    cdef
    list
    categories = []
...
def get_variable_nominal(self, variable_name=None, valueref=None, _override_erroneous_nominal=True):
    """
        ...
        """
    cdef
    FMIL.fmi2_import_variable_t * variable
    cdef
    FMIL.fmi2_import_real_variable_t * real_variable
    cdef
    FMIL.fmi2_real_t
    value
    cdef
    ...
    if valueref != None:
        variable = FMIL.fmi2_import_get_variable_by_vr(self._fmu,
                                                       FMIL.fmi2_base_type_real, < FMIL.fmi2_value_reference_t > valueref)
        if variable == NULL:
            raise FMUException("The variable with value reference: %s, could not be found." % str(valueref))
    elif variable_name != None:
        variable_name = encode(variable_name)
...
def get_variable_by_valueref(self, valueref, type=0):
    ...
    variable = FMIL.fmi2_import_get_variable_by_vr(
        self._fmu, < FMIL.fmi2_base_type_enu_t > type, < FMIL.fmi2_value_reference_t > valueref)
    if variable == NULL:
        raise FMUException("The variable with the valuref %i could not be found." % valueref)
...
def get_variable_alias_base(self, variable_name):
    ...
    FMIL.fmi2_import_variable_t * variable
    cdef
    FMIL.fmi2_import_variable_t * base_variable
    cdef
    FMIL.fmi2_value_reference_t
    vr
...
def get_variable_alias(self, variable_name):
    ...
    FMIL.fmi2_import_variable_t * variable
    cdef
    FMIL.fmi2_import_variable_list_t * alias_list
    cdef
    FMIL.size_t
    alias_list_size
    cdef
    FMIL.fmi2_variable_alias_kind_enu_t
    alias_kind
    cdef
    dict
    ret_values = {}
...
def get_model_time_varying_value_references(self, filter=None):
    ...
    FMIL.fmi2_import_variable_t * variable
    cdef
    FMIL.fmi2_import_variable_list_t * variable_list
    cdef
    FMIL.size_t
    variable_list_size
    cdef
    ...
    cdef
    FMIL.fmi2_variability_enu_t
    data_variability, target_variability
    cdef
    FMIL.fmi2_variable_alias_kind_enu_t
    alias_kind
    cdef
...
cdef
FMIL.fmi2_base_type_enu_t
data_type, target_type = FMIL.fmi2_base_type_real
cdef
FMIL.fmi2_variability_enu_t
data_variability, target_variability = FMIL.fmi2_variability_enu_constant
cdef
FMIL.fmi2_causality_enu_t
data_causality, target_causality = FMIL.fmi2_causality_enu_parameter
cdef
FMIL.fmi2_variable_alias_kind_enu_t
alias_kind
cdef
FMIL.fmi2_initial_enu_t
initial
cdef
char * desc
cdef
...
def get_variable_declared_type(self, variable_name):
    ...
    vr
    cdef
    FMIL.fmi2_import_variable_typedef_t * variable_type
    cdef
    FMIL.fmi2_base_type_enu_t
    type
    cdef
    FMIL.fmi2_import_enumeration_typedef_t * enumeration_type
    cdef
    FMIL.fmi2_import_integer_typedef_t * integer_type
    cdef
    FMIL.fmi2_import_real_typedef_t * real_type
    cdef
    FMIL.fmi2_import_unit_t * type_unit
    cdef
    FMIL.fmi2_import_display_unit_t * type_display_unit
    cdef
    char * type_name
    cdef
    char * type_desc
    cdef
    object
    ret_type, min_val, max_val, unbounded, nominal_val
    cdef
    char * type_quantity
    cdef
    unsigned
    ...
    if type == FMIL.fmi2_base_type_enum:
        ...
        ret_type = RealType2(decode(type_name) if type_name != NULL else "",
                             ...
                             decode(type_display_unit_name) if type_display_unit_name != NULL else "",
                             decode(type_unit_name) if type_unit_name != NULL else "")
    else:
        raise NotImplementedError
...
cpdef
FMIL.fmi2_initial_enu_t
get_variable_initial(self, variable_name) except *:
"""
...
def get_variable_unit(self, variable_name):
    ...
    FMIL.fmi2_import_real_variable_t * real_variable
    cdef
    FMIL.fmi2_import_unit_t * unit
    cdef
    FMIL.fmi2_base_type_enu_t
    type
    cdef
    char * unit_description
    ...
    if type != FMIL.fmi2_base_type_real:
        raise FMUException(
            "The variable %s is not a Real variable. Units only exists for Real variables." % variablename)
...
def get_variable_relative_quantity(self, variable_name):
    ...
    if type != FMIL.fmi2_base_type_real:
        raise FMUException(
            "The variable %s is not a Real variable. Relative quantity only exists for Real variables." % variablename)
...
def get_variable_display_unit(self, variable_name):
    ...
    FMIL.fmi2_import_real_variable_t * real_variable
    cdef
    FMIL.fmi2_import_display_unit_t * display_unit
    cdef
    FMIL.fmi2_base_type_enu_t
    type
    cdef
    char * display_unit_description
    ...
    if type != FMIL.fmi2_base_type_real:
        raise FMUException(
            "The variable %s is not a Real variable. Display units only exists for Real variables." % variablename)
...
def get_variable_display_value(self, variable_name):
    ...
    FMIL.fmi2_import_display_unit_t * display_unit
    cdef
    FMIL.fmi2_import_variable_typedef_t * variable_typedef
    cdef
    FMIL.fmi2_import_real_typedef_t * variable_real_typedef
    cdef
    FMIL.fmi2_real_t
    display_value, value
    cdef
...
type
cdef
FMIL.fmi2_import_integer_variable_t * int_variable
cdef
FMIL.fmi2_import_real_variable_t * real_variable
cdef
FMIL.fmi2_import_bool_variable_t * bool_variable
cdef
FMIL.fmi2_import_enum_variable_t * enum_variable
cdef
FMIL.fmi2_import_string_variable_t * str_variable
cdef
int
status
cdef
...
status
cdef
FMIL.fmi2_FMU_state_t
internal_state = state.fmu_state
...
cpdef
serialize_fmu_state(self, state):
"""
...
n_bytes
cdef
N.ndarray[FMIL.fmi2_byte_t, ndim = 1, mode = 'c'] serialized_fmu
...
status = FMIL.fmi2_import_serialize_fmu_state(self._fmu,
                                              internal_state.fmu_state, < FMIL.fmi2_byte_t * > serialized_fmu.data, n_bytes)
...
cpdef
deserialize_fmu_state(self, serialized_fmu):
"""
...
status
cdef
N.ndarray[FMIL.fmi2_byte_t, ndim = 1, mode = 'c'] ser_fmu = serialized_fmu[0]
cdef
FMUState2
state = FMUState2()
cdef
...
status = FMIL.fmi2_import_de_serialize_fmu_state(self._fmu, < FMIL.fmi2_byte_t * > ser_fmu.data, n_byte, & (
    state.fmu_state))
...
cpdef
serialized_fmu_state_size(self, state):
"""
...
cdef
_add_scalar_variables(self, FMIL.fmi2_import_variable_list_t * variable_list):
"""
...
cdef
_add_scalar_variable(self, FMIL.fmi2_import_variable_t * variable):
...
cpdef
get_derivatives_dependencies(self):
"""
...
def _get_directional_proxy(self, var_ref, func_ref, group=None, add_diag=False, output_matrix=None):
    ...
    cdef
    int
    nbr_var_ref = len(var_ref), nbr_func_ref = len(func_ref)
    cdef
    N.ndarray[FMIL.fmi2_real_t, ndim = 1, mode = 'c'] v = N.zeros(nbr_var_ref, dtype=N.double)
    cdef
    N.ndarray[FMIL.fmi2_real_t, ndim = 1, mode = 'c'] data_local
    cdef
    int
    ind_local = 5 if add_diag else 4
    ...
    if group is not None:
        ...
        if output_matrix is None or \
                ...
                (isinstance(output_matrix, N.ndarray) and (
                        output_matrix.shape[0] != nbr_func_ref or output_matrix.shape[1] != nbr_var_ref)):
...
def _get_A(self, use_structure_info=True, add_diag=True, output_matrix=None):
    ...
    A = self._get_directional_proxy(self._states_references, self._derivatives_references,
                                    self._group_A if use_structure_info else None, add_diag=add_diag,
...
def _get_B(self, use_structure_info=True, add_diag=False, output_matrix=None):
    ...
    B = self._get_directional_proxy(self._inputs_references, self._derivatives_references,
                                    self._group_B if use_structure_info else None, add_diag=add_diag,
                                    output_matrix=output_matrix)
...
def _get_C(self, use_structure_info=True, add_diag=False, output_matrix=None):
    ...
    C = self._get_directional_proxy(self._states_references, self._outputs_references,
                                    self._group_C if use_structure_info else None, add_diag=add_diag,
                                    output_matrix=output_matrix)
...
def _get_D(self, use_structure_info=True, add_diag=False, output_matrix=None):
    ...
    D = self._get_directional_proxy(self._inputs_references, self._outputs_references,
                                    self._group_D if use_structure_info else None, add_diag=add_diag,
                                    output_matrix=output_matrix)
...
def get_directional_derivative(self, var_ref, func_ref, v):
    ...
    # input arrays
    cdef
    N.ndarray[FMIL.fmi2_value_reference_t, ndim = 1, mode = 'c'] v_ref = N.zeros(len(var_ref), dtype=N.uint32)
    cdef
    N.ndarray[FMIL.fmi2_value_reference_t, ndim = 1, mode = 'c'] z_ref = N.zeros(len(func_ref), dtype=N.uint32)
    cdef
    N.ndarray[FMIL.fmi2_real_t, ndim = 1, mode = 'c'] dv = N.zeros(len(v), dtype=N.double)
    # output array
    cdef
    N.ndarray[FMIL.fmi2_real_t, ndim = 1, mode = 'c'] dz = N.zeros(len(func_ref), dtype=N.double)
    ...
    if status != 0:
        raise FMUException(
            'An error occured while getting the directional derivative, see the log for possible more information')
...
cdef
int
_get_directional_derivative(self, N.ndarray[FMIL.fmi2_value_reference_t, ndim = 1, mode = "c"] v_ref,
                                                                                               N.ndarray[
                                                                                                   FMIL.fmi2_value_reference_t, ndim = 1, mode = "c"] z_ref,
                                                                                                                                                      N.ndarray[
                                                                                                                                                          FMIL.fmi2_real_t, ndim = 1, mode = "c"] dv,
                                                                                                                                                                                                  N.ndarray[
                                                                                                                                                                                                      FMIL.fmi2_real_t, ndim = 1, mode = "c"] dz) except -1:
cdef
int
status
...
def get_version(self):
    """
        ...
        """
    cdef
    char * version = FMIL.fmi2_import_get_version(self._fmu)
    return decode(version)
...
def get_variable_naming_convention(self):
    """
        ...
        """
    cdef
    FMIL.fmi2_variable_naming_convension_enu_t
    conv
...
class FMUModelCS2(FMUModelBase2):
    """
...
cpdef
_set_time(self, FMIL.fmi2_real_t
t):
"""
...
cpdef
int
do_step(self, FMIL.fmi2_real_t
current_t, FMIL.fmi2_real_t
step_size, new_step = True):
"""
        Performs an integrator step.
...
def set_input_derivatives(self, variables, values, FMIL.
...
cdef
N.ndarray[FMIL.fmi2_value_reference_t, ndim = 1, mode = 'c'] value_refs
cdef
N.ndarray[FMIL.fmi2_real_t, ndim = 1, mode = 'c']            val = N.array(values, dtype=N.float, ndmin=1).ravel()
...
cdef
int
_set_input_derivatives(self, N.ndarray[FMIL.fmi2_value_reference_t, ndim = 1, mode = "c"] value_refs,
                                                                                          N.ndarray[
                                                                                              FMIL.fmi2_real_t, ndim = 1, mode = "c"] values,
                                                                                                                                      N.ndarray[
                                                                                                                                          FMIL.fmi2_integer_t, ndim = 1, mode = "c"] orders):
cdef
int
status
...
cdef
int
_get_output_derivatives(self, N.ndarray[FMIL.fmi2_value_reference_t, ndim = 1, mode = "c"] value_refs,
                                                                                           N.ndarray[
                                                                                               FMIL.fmi2_real_t, ndim = 1, mode = "c"] values,
                                                                                                                                       N.ndarray[
                                                                                                                                           FMIL.fmi2_integer_t, ndim = 1, mode = "c"] orders):
...
def get_capability_flags(self):
    ...
    dict
    capabilities = {}
    capabilities['needsExecutionTool'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_cs_needsExecutionTool))
    capabilities['canHandleVariableCommunicationStepSize'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_cs_canHandleVariableCommunicationStepSize))
    capabilities['canInterpolateInputs'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_cs_canInterpolateInputs))
    capabilities['maxOutputDerivativeOrder'] = FMIL.fmi2_import_get_capability(self._fmu,
                                                                               FMIL.fmi2_cs_maxOutputDerivativeOrder)
    capabilities['canRunAsynchronuously'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_cs_canRunAsynchronuously))
    capabilities['canBeInstantiatedOnlyOncePerProcess'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_cs_canBeInstantiatedOnlyOncePerProcess))
    capabilities['canNotUseMemoryManagementFunctions'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_cs_canNotUseMemoryManagementFunctions))
    capabilities['canGetAndSetFMUstate'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_cs_canGetAndSetFMUstate))
    capabilities['canSerializeFMUstate'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_cs_canSerializeFMUstate))
    capabilities['providesDirectionalDerivatives'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_cs_providesDirectionalDerivatives))
...
class FMUModelME2(FMUModelBase2):
    """
...
cdef
int
_get_event_indicators(self, FMIL.fmi2_real_t[:]
values):
...
def get_event_indicators(self):
    ...
    status
    cdef
    N.ndarray[FMIL.fmi2_real_t, ndim = 1, mode = 'c'] values = N.empty(self._nEventIndicators, dtype=N.double)
...
cdef
int
_completed_integrator_step(self, int * enter_event_mode, int * terminate_simulation):
cdef
int
status
cdef
FMIL.fmi2_boolean_t
noSetFMUStatePriorToCurrentPoint = FMI2_TRUE
cdef
FMIL.fmi2_boolean_t
enterEventMode
cdef
...
status = FMIL.fmi2_import_completed_integrator_step(self._fmu,
...
def completed_integrator_step(self, no_set_FMU_state_prior_to_current_point=True):
    ...
    cdef
    FMIL.fmi2_boolean_t
    noSetFMUStatePriorToCurrentPoint = FMI2_TRUE if no_set_FMU_state_prior_to_current_point else FMI2_FALSE
    cdef
    FMIL.fmi2_boolean_t
    enterEventMode
    cdef
...
cdef
int
__get_continuous_states(self, FMIL.fmi2_real_t[:]
ndx):
...
def _get_continuous_states(self):
    ...
    status
    cdef
    N.ndarray[FMIL.fmi2_real_t, ndim = 1, mode = 'c'] ndx = N.zeros(self._nContinuousStates, dtype=N.double)
...
cdef
int
__set_continuous_states(self, FMIL.fmi2_real_t[:]
ndx):
if self._nContinuousStates > 0:
...
def _set_continuous_states(self, N.
    ...
    ndarray[FMIL.fmi2_real_t, ndim = 1, mode = "c"] values):
"""
...
status
cdef
N.ndarray[FMIL.fmi2_real_t, ndim = 1, mode = 'c'] ndx = values
...
cdef
int
_get_derivatives(self, FMIL.fmi2_real_t[:]
values):
if self._nContinuousStates > 0:
...
status
cdef
N.ndarray[FMIL.fmi2_real_t, ndim = 1, mode = 'c'] values = N.empty(self._nContinuousStates, dtype=N.double)
...
def get_capability_flags(self):
    ...
    capabilities = {}
    capabilities['needsExecutionTool'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_me_needsExecutionTool))
    capabilities['completedIntegratorStepNotNeeded'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_me_completedIntegratorStepNotNeeded))
    capabilities['canBeInstantiatedOnlyOncePerProcess'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_me_canBeInstantiatedOnlyOncePerProcess))
    capabilities['canNotUseMemoryManagementFunctions'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_me_canNotUseMemoryManagementFunctions))
    capabilities['canGetAndSetFMUstate'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_me_canGetAndSetFMUstate))
    capabilities['canSerializeFMUstate'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_me_canSerializeFMUstate))
    capabilities['providesDirectionalDerivatives'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_me_providesDirectionalDerivatives))
    capabilities['completedEventIterationIsProvided'] = bool(
        FMIL.fmi2_import_get_capability(self._fmu, FMIL.fmi2_me_completedEventIterationIsProvided))
...
cdef
int
sol_found = 0, dim = 0, i, j, len_v = len(var_ref), len_f = len(func_ref), local_indices_vars_nbr, status
cdef
double
nominal, fac, tmp
cdef
int
method = FORWARD_DIFFERENCE if self.force_finite_differences is True or self.force_finite_differences == 0 else CENTRAL_DIFFERENCE
cdef
double
RUROUND = FORWARD_DIFFERENCE_EPS if method == FORWARD_DIFFERENCE else CENTRAL_DIFFERENCE_EPS
cdef
N.ndarray[FMIL.fmi2_real_t, ndim = 1, mode = 'c'] dfpert, df, eps
cdef
N.ndarray[FMIL.fmi2_value_reference_t, ndim = 1, mode = 'c'] v_ref = N.array(var_ref, copy=False, dtype=N.uint32)
cdef
N.ndarray[FMIL.fmi2_value_reference_t, ndim = 1, mode = 'c'] z_ref = N.array(func_ref, copy=False, dtype=N.uint32)
cdef
int
ind_local = 5 if add_diag else 4
cdef
...
cdef
FMIL.fmi2_real_t * column_data_pt
cdef
FMIL.fmi2_real_t * v_pt
cdef
FMIL.fmi2_real_t * df_pt
cdef
FMIL.fmi2_real_t * eps_pt
cdef
FMIL.fmi2_real_t * tmp_val_pt
cdef
FMIL.fmi2_real_t * output_matrix_data_pt = NULL
cdef
FMIL.fmi2_value_reference_t * v_ref_pt = < FMIL.fmi2_value_reference_t * > PyArray_DATA(v_ref)
cdef
FMIL.fmi2_value_reference_t * z_ref_pt = < FMIL.fmi2_value_reference_t * > PyArray_DATA(z_ref)
cdef
FMIL.fmi2_value_reference_t * local_v_vref_pt
cdef
FMIL.fmi2_value_reference_t * local_z_vref_pt
cdef
int * local_indices_vars_pt
cdef
int * local_indices_matrix_rows_pt
cdef
int * local_indices_matrix_columns_pt
cdef
int * local_data_indices
...
if group is not None:
    ...
    for key in group["groups"]:
        ...
        for fac in [1.0, 0.1, 0.01,
                    0.001]:  # In very special cases, the epsilon is too big, if an error, try to reduce eps
            for i in range(local_indices_vars_nbr): tmp_val_pt[i] = v_pt[local_indices_vars_pt[i]] + fac * eps_pt[
                local_indices_vars_pt[i]]
            ...
            if method == FORWARD_DIFFERENCE:  # Forward and Backward difference
                ...
                if status == 0:
                    for i in range(local_indices_matrix_rows_nbr):
                        column_data_pt[i] = (tmp_val_pt[i] - df_pt[local_indices_matrix_rows_pt[i]]) / (
                                fac * eps_pt[local_indices_matrix_columns_pt[i]])

                    sol_found = 1
                else:  # Backward

                    for i in range(local_indices_vars_nbr): tmp_val_pt[i] = v_pt[local_indices_vars_pt[i]] - fac * \
                                                                            eps_pt[local_indices_vars_pt[i]]
                    self.__set_real(local_v_vref_pt, tmp_val_pt, local_indices_vars_nbr)

                    status = self.__get_real(local_z_vref_pt, local_indices_matrix_rows_nbr, tmp_val_pt)
                    if status == 0:
                        for i in range(local_indices_matrix_rows_nbr):
                            column_data_pt[i] = (df_pt[local_indices_matrix_rows_pt[i]] - tmp_val_pt[i]) / (
                                        fac * eps_pt[local_indices_matrix_columns_pt[i]])
    ...
    if output_matrix is None or \
            (not isinstance(output_matrix, N.ndarray)) or \
            (isinstance(output_matrix, N.ndarray) and (
                    output_matrix.shape[0] != len_f or output_matrix.shape[1] != len_v)):
...
class __ForTestingFMUModelME2(FMUModelME2):
    cdef
    int
    __get_real(self, FMIL.fmi2_value_reference_t * vrefs, size_t
    size, FMIL.fmi2_real_t * values):
...
class FMUModel(FMUModelME1):
    def __init__(self, fmu, path='.', enable_logging=True):
        print(
            "WARNING: This class is deprecated and has been superseded with FMUModelME1. The recommended entry-point for loading an FMU is now the function load_fmu.")
...
def load_fmu(fmu, path='.', enable_logging=None, log_file_name="", kind='auto', log_level=FMI_DEFAULT_LOG_LEVEL):
    ...
    last_error
    cdef
    FMIL.fmi_version_enu_t
    version
    cdef
    FMIL.fmi1_import_t * fmu_1 = NULL
    cdef
    FMIL.fmi2_import_t * fmu_2 = NULL
    cdef
    FMIL.fmi1_fmu_kind_enu_t
    fmu_1_kind
    cdef
    FMIL.fmi2_fmu_kind_enu_t
    fmu_2_kind
    cdef
    list
    log_data = []
    ...
    if version == FMIL.fmi_version_1_enu:
        ...
        if fmu_1_kind == FMI_ME and kind.upper() != 'CS':
            ...
            _handle_load_fmu_exception(fmu, log_data)
            raise FMUException(
                "FMU is a {} and not a {}".format(decode(FMIL.fmi1_fmu_kind_to_string(fmu_1_kind)), kind.upper()))
        ...
        if model is None:
            ...
            FMIL.fmi_import_rmdir( & callbacks, fmu_temp_dir)
            _handle_load_fmu_exception(fmu, log_data)
            raise FMUException("FMU is a {} and not a {}".format(decode(FMIL.fmi2_fmu_kind_to_string(fmu_2_kind)),
                                                                 decode(kind.upper())))
...
cdef
N.ndarray
get_real_numpy_vector(self, int
index):
cdef
N.ndarray
ret = None
...
cdef
FMIL.fmi2_real_t * get_real_vector(self, int
index):
cdef
FMIL.fmi2_real_t * ret = NULL
if index == 0:
...
cdef
N.ndarray
get_value_reference_numpy_vector(self, int
index):
cdef
N.ndarray
ret = None
...
cdef
FMIL.fmi2_value_reference_t * get_value_reference_vector(self, int
index):
cdef
FMIL.fmi2_value_reference_t * ret = NULL
if index == 0:

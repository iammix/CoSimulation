...
from fmup import Fmi2Slave
from fmup.enums import Fmi2Causality, Fmi2Initial, Fmi2Variability
from fmup.variables import Boolean, Integer, Real, ScalarVariable, String
...
def test_ScalarVariable_setter(fmi_type, value):
    ...
    slave = Slave(insfrom enum import Enum
from random import randint
...
def test_ScalarVariable_to_xml(causality, initiadl, variability, name, description):
    var = ScalarVariable(name, causality, description, initial, variability)
    valueReference = randint(0, 250000)
    var.value_reference = valueReference

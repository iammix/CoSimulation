...
from fmup.builder import FmuBuilder
from fmup.enums import Fmi2Status
from fmup.fmi2slave import Fmi2Slave

fmpy = pytest.importorskip("fmpy", reason="fmpy is not available for testing the produced FMU")
...
def test_logger(tmp_path, debug_logging):
    ...
    slave_code = f"""from fmup.fmi2slave import Fmi2Slave, Fmi2Status, Fmi2Causality, Integer, Real, Boolean, String

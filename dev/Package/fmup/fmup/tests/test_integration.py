...
from fmup.fmi2slave import Fmi2Slave, Fmi2Causality, Integer, Real, Boolean, String
...
def test_integration_throw_py_error(tmp_path):
    ...
    slave_code = """from fmup.fmi2slave import Fmi2Slave, Fmi2Causality, Integer, Real, Boolean, String

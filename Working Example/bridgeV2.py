...
class Bridge(object):
    ...
    def __init__(self, elenum, vel, L, A, MassPerLength, E, Izz, cs_timestep, tag):
        self.tag = tag
        self.cs_timestep = cs_timestep
        self.vel = vel
        self.elenum = elenum
...
def main(dt, t):
    ...
    B = Bridge(meshnum, velocity, length, section_area, massperlength, youngmodulus, izz, dt, t)
    lc = np.array([-10, -10])

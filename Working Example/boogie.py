...
class Boogie(object):
    ...
    def get_interface_output(self):
        return self.state_current[self.interface_dof - 1], self.state_current[self.dofs + self.interface_dof - 1], \
               self.state_current[2 * self.dofs + self.interface_dof - 1]
...
def main():
    # m, c, k, dofs, interface_dof, interface_coef, intergrator='Newmark', lagrange=False
    b = Boogie(1, 1, 1, 1, 1, 1, intergrator='Newmark', lagrange=False)
    b.set_interface_input(10, 1, 1000)
    b.solve()

from fmup.fmi2slave import Fmi2Slave, Fmi2Causality, Fmi2Variability, Integer, Real, Boolean, String
...
class Depend(Fmi2Slave):
    ...
    def __init__(self, **kwargs):
        ...
        # Register Variables
        self.register_variable(Integer("intParam", causality=Fmi2Causality.parameter, variability=Fmi2Variability.tunable))
        ...
        sub.someInteger = -15
        self.register_variable(Real("container.someReal", causality=Fmi2Causality.parameter, variability=Fmi2Variability.tunable))
        self.register_variable(Integer("container.subContainer.someInteger", causality=Fmi2Causality.parameter, variability=Fmi2Variability.tunable))
